...
public class ProductTestCase {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * //Deletion TestCase Product product=productDAO.getProduct(2);
		 * productDAO.deleteProduct(product); System.out.println("The Product Deleted");
		 * 
		 * //Retrieving the Data
		 * 
		 ...
		 * System.out.println(product.getCatid()+":"+product.getCatname()+":"+product.
		 * getCatdesc()); }
		 * 
		 * 
		 * Product product=productDAO.getProduct(1); product.setCatname("Shirt");
		 * productDAO.insertUpdateProduct(product);
