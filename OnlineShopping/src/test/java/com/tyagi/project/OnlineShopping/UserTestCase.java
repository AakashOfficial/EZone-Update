...
public class UserTestCase {
	public static void main(String[] args) {
		 ...
		 * System.out.println(user3.getUsername()+":"+user3.getPassword()+":"+user3.
		 * getRole()); }
		 * 
		 * //Update the User UserRegister user4=userDAO.getUser(""); user4.setRole("");
		 * userDAO.insertUpdateUser(user4); System.out.println("The User Updated");
		 */
